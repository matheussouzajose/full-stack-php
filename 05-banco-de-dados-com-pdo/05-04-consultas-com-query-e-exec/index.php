...
$insert = "
    ...
    VALUES ('Matheus', 'Jose', 'matheus.jose@via.com', '374805659')
";
...
//    var_dump(Connect::getInstace()->lastInsertId());
//
//    var_dump(
//        $exec,
//        $query->errorInfo()
...
try {
    $query = Connect::getInstace()->query("SELECT * FROM users");
...
try {
    $exec = Connect::getInstace()->exec("
        UPDATE users SET first_name = 'Luva', last_name = 'Pedreiro'
        WHERE id = '1'
    ");
